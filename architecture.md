...
## 📌 Overview
This project simulates an end-to-end migration from on-premise infrastructure to AWS using Terraform. It demonstrates rehost (EC2) and replatform (RDS) strategies with real-time data migration using AWS DMS.
